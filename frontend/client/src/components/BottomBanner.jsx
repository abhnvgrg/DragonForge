...
export function BottomBanner() {
  ...
  return (
    <footer className="border-t border-dragonforge-border bg-dragonforge-surface sticky bottom-0 z-30">
      <button
        onClick={() => setIsOpen(!isOpen)}
        className="w-full flex items-center justify-between px-6 py-4 font-mono text-small text-dragonforge-textSecondary hover:text-dragonforge-textPrimary focus:outline-none"
      ...
      {isOpen && (
        <div className="px-6 pb-6 pt-2 border-t border-dragonforge-border/30 bg-dragonforge-bg/90 animate-slide-up">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-4">
            {/* Column 1: 100M+ Scale */}
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-dragonforge-textPrimary">
                <Cpu className="w-4 h-4 text-dragonforge-textPrimary" />
                <h4 className="font-mono text-small font-medium">100M+ Parameter Scaling</h4>
              </div>
              <p className="text-small text-dragonforge-textSecondary leading-relaxed">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-dragonforge-textPrimary">
                <ShieldAlert className="w-4 h-4 text-dragonforge-textPrimary" />
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-dragonforge-textPrimary">
                <Layers className="w-4 h-4 text-dragonforge-textPrimary" />
          ...
          <div className="mt-6 pt-4 border-t border-dragonforge-border/30 flex justify-between items-center text-tiny text-dragonforge-textMuted font-mono">
